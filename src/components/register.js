...
<input onChange={(e)=>setUserDetails({...userDetails, name:e.target.value})} type='text' name='name' placeholder='First & Last Name'/>

<input onChange={(e)=>setUserDetails({...userDetails, email:e.target.value})} type='email' name='email' placeholder='Email'/>

<input onChange={(e)=>setUserDetails({...userDetails, phone:e.target.value})} type='phone' name='phone' placeholder=''/>
